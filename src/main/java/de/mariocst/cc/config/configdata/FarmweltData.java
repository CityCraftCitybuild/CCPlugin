...
public class FarmweltData {
    private static FarmweltData farmweltData;
    ...
    public FarmweltData() {
        ...
        if (config.getConfig().contains("farmwelt") && this.config.getConfig().getConfigurationSection("farmwelt") != null) {
            Map<String, Object> values = Objects.requireNonNull(this.config.getConfig().getConfigurationSection("farmwelt")).getValues(true);
    ...
    public static FarmweltData getFarmweltData() {
        return farmweltData;
    }
    ...
    public void save() {
        if (config.getConfig().contains("farmwelt") && this.config.getConfig().getConfigurationSection("farmwelt") != null) {
            ...
            config.getConfig().set("farmwelt", values);
        }
        else {
