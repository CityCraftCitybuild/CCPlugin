...
public class NetherData {
    private static NetherData netherData;
    ...
    public NetherData() {
        ...
        if (config.getConfig().contains("nether") && this.config.getConfig().getConfigurationSection("nether") != null) {
            Map<String, Object> values = Objects.requireNonNull(this.config.getConfig().getConfigurationSection("nether")).getValues(true);

            if (!values.containsKey("world_name")) {
                values.put("world_name", "world_nether");
            }
    ...
    public static NetherData getNetherData() {
        return netherData;
    }
    ...
    public void save() {
        if (config.getConfig().contains("nether") && this.config.getConfig().getConfigurationSection("nether") != null) {
            ...
            config.getConfig().set("nether", values);
        }
        else {
