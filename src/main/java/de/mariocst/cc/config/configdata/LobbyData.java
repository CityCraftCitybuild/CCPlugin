...
public class LobbyData {
    private static LobbyData lobbyData;
    ...
    public LobbyData() {
        ...
        if (config.getConfig().contains("lobby") && this.config.getConfig().getConfigurationSection("lobby") != null) {
            Map<String, Object> values = Objects.requireNonNull(this.config.getConfig().getConfigurationSection("lobby")).getValues(true);

            if (!values.containsKey("world_name")) {
                values.put("world_name", "lobby");
            }
    ...
    public void save() {
        if (config.getConfig().contains("lobby") && this.config.getConfig().getConfigurationSection("lobby") != null) {
            ...
            config.getConfig().set("lobby", values);
        }
        else {
